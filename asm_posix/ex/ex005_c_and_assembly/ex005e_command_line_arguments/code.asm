...
progn:
	db "program: ex005e_command_line_arguments"; note: omit line-feed as `puts` does it for us
...
echo_argv:
	...
	; * - {rsi}: address of string to output, i.e arguments passed to command
	; * line (argv)
...
.next_argv_elem_inc_rsi:
	add rsi, 8; point to the next argument in {rsi} i.e. long *{rsi} or `char *argv[]`
